...
FILE_NAME = '83C90757-9B01-47E0-AF0C-B1BE2AC6FBC7_jpeg.rf.1546882c2da06eac535f92cbf81e33e3'


# Set the paths for the images and labels folders
images_folder = './augmentation/images'
labels_folder = './augmentation/labels'
...
for image_file in image_files:
    if not image_file.endswith(f"{FILE_NAME}.jpg"):
      continue  
